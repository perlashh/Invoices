...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تحديث
                فاتورة</span>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <form action=" {{  url('update_status') }}/{{ $invoices->id }}" method="post"
                     enctype="multipart/form-data" autocomplete="off">

                     {{-- <form action=" {{  route('update_status' ,['id' => $invoices->id]) }}" method="post"
                        enctype="multipart/form-data" autocomplete="off"> --}}
					{{-- {{ method_field('patch') }} --}}
                    {{ csrf_field() }}
                {{-- ----1 --}}
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                            type="text" value="{{ $invoices->invoice_Date }}" readonly required>
                    </div>

                    <div class="col">
                        <label>تاريخ الاستحقاق</label>
                        <input class="form-control fc-datepicker" name="Due_date" placeholder="YYYY-MM-DD" type="text"
                            value="{{ $invoices->Due_date }}" readonly required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control form-control-lg" id="Amount_Commission"
                            ...
                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                            value="{{ $invoices->Amount_Commission }}" readonly required>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control form-control-lg" id="Discount" name="Discount"
                            ...
                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                            value="{{ $invoices->Discount }}" readonly required>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <select name="Status" class="form-control SlectBox" onclick="console.log($(this).val())"
                            ...
                            <option value=" جزئيا مدفوعة">مدفوعة جزئيا</option>
