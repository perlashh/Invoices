    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <form action="/search_invoices"  role="search" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="flexRadioDefault1">
                            ...
                            &nbsp&nbsp&nbsp&nbsp&nbsp <span> بحث بنوع
                                الفاتورة </span>
                        </label>
                    </div>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="flexRadioDefault2">
                            ...
                            &nbsp&nbsp&nbsp&nbsp&nbsp <span>بحث برقم الفاتورة </span>
                        </label>
                    </div>
                    ...
                    <div class="row">
                        <div class="col" id="type">
                            <label for="inputName" class="control-label">تحديد نوع الفواتير</label>
                            <select name="type" id="type" class="form-control">
                                <!--placeholder-->
                                <option value="{{ $type ?? 'حدد نوع الفواتير' }}" selected>
                                    {{ $type ?? 'حدد نوع الفواتير' }}</option>
                                {{-- <option value="" selected>
                                        حدد نوع الفواتير</option> --}}
                        ...
                        <div class="col" id="invoice_number">
                            <label for="inputName" class="control-label">البحث برقم الفاتورة</label>
