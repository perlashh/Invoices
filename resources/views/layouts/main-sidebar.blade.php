			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							@canany('قائمة الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">قائمة الفواتير</a></li>
							@endcanany
							@canany('الفواتير المدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='paid_ivoices') }}">الفواتير المدفوعة</a></li>
							@endcanany
							@canany('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='unpaid_invoices') }}">الفواتير الغير مدفوعة</a></li>
							@endcanany
							@canany('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('/' . $page='partlypaid_invoices') }}">الفواتير المدفوعة جزئيا</a></li>
							@endcanany
							@canany('ارشيف الفواتير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='invoicereport') }}">تقارير الفواتير</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='roles') }}">صلاحيات الستخدمين</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='productss') }}">المنتجات</a></li>
